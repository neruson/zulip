...
def check_none_or(sub_validator):
    # type: (Callable[[str, Any], Optional[str]]) -> Callable[[str, Any], Optional[str]]
    def f(var_name, val):
        # type: (str, Any) -> Optional[str]
        if val is None:
            return None
...
def check_list(sub_validator, length=None):
    # type: (Callable[[str, Any], Optional[str]], Optional[int]) -> Callable[[str, Any], Optional[str]]
    def f(var_name, val):
        # type: (str, Any) -> Optional[str]
...
def check_dict(required_keys):
    # type: (Iterable[Tuple[str, Callable[[str, Any], Optional[str]]]]) -> Callable[[str, Any], Optional[str]]
    def f(var_name, val):
        # type: (str, Any) -> Optional[str]
...
def check_variable_type(allowed_type_funcs):
    # type: (Iterable[Callable[[str, Any], Optional[str]]]) -> Callable[[str, Any], Optional[str]]
    """
...
def equals(expected_val):
    # type: (Any) -> Callable[[str, Any], Optional[str]]
    def f(var_name, val):
        # type: (str, Any) -> Optional[str]
        if val != expected_val:
